...
for n= layers
    ...
    xlabel("x");
    ylabel("y");
    title("Batch Mode Training with trainbr and "+n+" neurons"); 
    ...
    xlabel("x");
    ylabel("y");
    title("Batch Mode Training with trainbr and "+n+" neurons from -3 to 3"); 
    legend(["Network Output","Expected Output"]);
    k= 1+k;
    saveas(gcf, ['Batch mode number of neurons ',num2str(n),' with trainbr'], 'png');
end
